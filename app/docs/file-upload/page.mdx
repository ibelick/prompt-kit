...
import { BasicFileUpload } from "./basic-file-upload"
...
A simple file upload component with drag-and-drop support and a button trigger.

<ComponentCodePreview
  component={<BasicFileUpload />}
  filePath="app/docs/file-upload/basic-file-upload.tsx"
  classNameComponentContainer="p-8"
/>

### File Upload with Prompt Input

You can combine the file upload component with the [Prompt Input](/docs/prompt-input) component to create a full-featured input component with file upload support.
